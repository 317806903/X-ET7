...
namespace ET
{
    public static class OpcodeHelper
    {
        ...
        private static readonly HashSet<ushort> ignoreDebugLogMessageSet = new HashSet<ushort>
        {
            ...
            OuterMessage.M2C_TryMoveUnitAndGetAllMonsterCall2HeadQuarterPath,
            OuterMessage.M2C_GetMonsterCall2HeadQuarterPath,
            OuterMessage.M2C_GetNearestNavMeshPoint,
            OuterMessage.M2C_DrawAllMonsterCall2HeadQuarterPath,
#if !UNITY_EDITOR
            OuterMessage.C2M_TryMoveUnitAndGetAllMonsterCall2HeadQuarterPath,
            OuterMessage.C2M_GetMonsterCall2HeadQuarterPath,
            OuterMessage.C2M_GetNearestNavMeshPoint,
#endif
