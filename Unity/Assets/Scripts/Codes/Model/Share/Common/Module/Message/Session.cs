    ...
    public static class SessionSystem
    {
        ...
        public static void OnResponse(this Session self, IResponse response)
        {
            ...
            if (ErrorCore.IsRpcNeedThrowException(response.Error))
            {
                ...
                EventSystem.Instance.Publish(self.DomainScene(), new ClientEventType.NoticeUIHideCommonLoading());
                return;
            }
        ...
        public static async ETTask<IResponse> Call(this Session self, IRequest request, bool needShowLoading = true)
        {
            ...
            if (needShowLoading)
            {
                EventSystem.Instance.Publish(self.DomainScene(), new ClientEventType.NoticeUIShowCommonLoading());
            }
