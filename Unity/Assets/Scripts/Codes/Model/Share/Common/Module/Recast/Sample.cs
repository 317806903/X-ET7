...
namespace ET
{
    ...
    public class Sample
    {
        ...
        private List<RcBuilderResult> _recastResultsOrg;
        ...
        public void SetRecastResultsOrg(IList<RcBuilderResult> recastResults)
        {
            if (_recastResultsOrg == null && recastResults != null)
            {
                _recastResultsOrg = new();
                foreach (RcBuilderResult rcBuilderResult in recastResults)
                {
                    _recastResultsOrg.Add(rcBuilderResult);
                }
            }
        }

        public IList<RcBuilderResult> GetRecastResultsOrg()
        {
            return _recastResultsOrg;
        }
