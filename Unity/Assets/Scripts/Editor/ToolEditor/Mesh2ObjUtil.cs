...
public static class Mesh2ObjUtil
{
    ...
    public static void MeshToObj(MeshFilter mf, string datPath, string name)
    {
        using (StreamWriter streamWriter = new StreamWriter(string.Format("{0}{1}.obj", datPath, name)))
        {
    ...
    [MenuItem("ET/ExportSelectMeshToObj")]
    public static void SelectMeshToObj()
    {
        ...
        string path = @"E:\work\ARTowerDefense\Unity\Assets\Bundles";
        MeshToObj(selectObj.GetComponent<MeshFilter>(), path, "zpb1111");
    }
}