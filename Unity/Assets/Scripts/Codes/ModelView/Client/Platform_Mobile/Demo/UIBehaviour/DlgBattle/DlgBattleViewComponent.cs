...
namespace ET.Client
{
	...
	public class DlgBattleViewComponent : Entity, IAwake, IDestroy
	{
		...
		public UnityEngine.UI.Button EButton_TowerLeftButton
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_TowerLeftButton == null )
				{
					this.m_EButton_TowerLeftButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "GameObject/TowerRoot/ELoopScrollList_Tower/EButton_TowerLeft");
				}
				return this.m_EButton_TowerLeftButton;
			}
		}

		public UnityEngine.UI.Image EButton_TowerLeftImage
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_TowerLeftImage == null )
				{
					this.m_EButton_TowerLeftImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "GameObject/TowerRoot/ELoopScrollList_Tower/EButton_TowerLeft");
				}
				return this.m_EButton_TowerLeftImage;
			}
		}

		public UnityEngine.UI.Button EButton_TowerRightButton
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_TowerRightButton == null )
				{
					this.m_EButton_TowerRightButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "GameObject/TowerRoot/ELoopScrollList_Tower/EButton_TowerRight");
				}
				return this.m_EButton_TowerRightButton;
			}
		}

		public UnityEngine.UI.Image EButton_TowerRightImage
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_TowerRightImage == null )
				{
					this.m_EButton_TowerRightImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "GameObject/TowerRoot/ELoopScrollList_Tower/EButton_TowerRight");
				}
				return this.m_EButton_TowerRightImage;
			}
		}
		...
		public UnityEngine.UI.Button EButton_MonsterLeftButton
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_MonsterLeftButton == null )
				{
					this.m_EButton_MonsterLeftButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "GameObject/MonsterRoot/ELoopScrollList_Monster/EButton_MonsterLeft");
				}
				return this.m_EButton_MonsterLeftButton;
			}
		}

		public UnityEngine.UI.Image EButton_MonsterLeftImage
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_MonsterLeftImage == null )
				{
					this.m_EButton_MonsterLeftImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "GameObject/MonsterRoot/ELoopScrollList_Monster/EButton_MonsterLeft");
				}
				return this.m_EButton_MonsterLeftImage;
			}
		}

		public UnityEngine.UI.Button EButton_MonsterRightButton
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_MonsterRightButton == null )
				{
					this.m_EButton_MonsterRightButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "GameObject/MonsterRoot/ELoopScrollList_Monster/EButton_MonsterRight");
				}
				return this.m_EButton_MonsterRightButton;
			}
		}

		public UnityEngine.UI.Image EButton_MonsterRightImage
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_MonsterRightImage == null )
				{
					this.m_EButton_MonsterRightImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "GameObject/MonsterRoot/ELoopScrollList_Monster/EButton_MonsterRight");
				}
				return this.m_EButton_MonsterRightImage;
			}
		}
		...
		public void DestroyWidget()
		{
			...
			this.m_EButton_TowerLeftButton = null;
			this.m_EButton_TowerLeftImage = null;
			this.m_EButton_TowerRightButton = null;
			this.m_EButton_TowerRightImage = null;
			...
			this.m_EButton_MonsterLeftButton = null;
			this.m_EButton_MonsterLeftImage = null;
			this.m_EButton_MonsterRightButton = null;
			this.m_EButton_MonsterRightImage = null;
		...
		private UnityEngine.UI.Button m_EButton_TowerLeftButton = null;
		private UnityEngine.UI.Image m_EButton_TowerLeftImage = null;
		private UnityEngine.UI.Button m_EButton_TowerRightButton = null;
		private UnityEngine.UI.Image m_EButton_TowerRightImage = null;
		...
		private UnityEngine.UI.Button m_EButton_MonsterLeftButton = null;
		private UnityEngine.UI.Image m_EButton_MonsterLeftImage = null;
		private UnityEngine.UI.Button m_EButton_MonsterRightButton = null;
		private UnityEngine.UI.Image m_EButton_MonsterRightImage = null;
