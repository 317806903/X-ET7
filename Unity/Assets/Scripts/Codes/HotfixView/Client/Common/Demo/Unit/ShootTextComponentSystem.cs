...
namespace ET.Client
{
    public static class ShootTextComponentSystem
    {
        ...
        public static async ETTask Init(this ShootTextComponent self)
        {
            ...
            self.shootTextProManager_Normal.UITextCamera = GlobalComponent.Instance.UICamera;
            self.shootTextProManager_High.UITextCamera = GlobalComponent.Instance.UICamera;
            self.shootTextProManager_Crt.UITextCamera = GlobalComponent.Instance.UICamera;
            self.shootTextProManager_CrtAndHigh.UITextCamera = GlobalComponent.Instance.UICamera;
            self.shootTextProManager_Cure.UITextCamera = GlobalComponent.Instance.UICamera;
            ...
            self.shootTextProManager_Normal.ShootTextCanvas = _DlgBattleTowerHUDShow.View.EGDamageRootRectTransform;
            self.shootTextProManager_High.ShootTextCanvas = _DlgBattleTowerHUDShow.View.EGDamageRootRectTransform;
            self.shootTextProManager_Crt.ShootTextCanvas = _DlgBattleTowerHUDShow.View.EGDamageRootRectTransform;
            self.shootTextProManager_CrtAndHigh.ShootTextCanvas = _DlgBattleTowerHUDShow.View.EGDamageRootRectTransform;
            self.shootTextProManager_Cure.ShootTextCanvas = _DlgBattleTowerHUDShow.View.EGDamageRootRectTransform;
        }
        ...
        public static void ShowShootDamage(this ShootTextComponent self, Unit unit, int value, bool isCrt)
        {
            ...
            shootTextProManager?.CreatShootText(clientResScale, isNeedShowPreOperator, TextMoveType.None, showValue, () =>
            {
        ...
        {
            float clientResScale = ET.Ability.UnitHelper.GetClientGameResScale(self.DomainScene());
            return (Vector3)unit.GetUnitClientPos() + Vector3.up * (ET.Ability.UnitHelper.GetBodyHeight(unit) + clientResScale * 1.2f);
        }
