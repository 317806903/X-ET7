...
namespace ET.Ability
{
    namespace AbilityTriggerEventType
    {
        ...
        public struct GamePlayTowerDefense_UpgradeItemUnit
        {
            public ActionContext actionContext;
            public long playerId;
        ...
        public struct GamePlayTowerDefense_MoveTower
        {
            public ActionContext actionContext;
            public long playerId;
            public Unit towerUnit;
        ...
        public struct GamePlay_Status_LoadMeshFinished_First
        {
            public ActionContext actionContext;
        }

        public struct GamePlay_Status_LoadMeshFinished
        {
            public ActionContext actionContext;
        }

        public struct GamePlay_Status_AddPlayerWhenGlobal
        {
            public ActionContext actionContext;
        }

        public struct GamePlay_Status_PlayerQuit
        {
            public ActionContext actionContext;
        }
        ...
        public struct GamePlayTowerDefense_ChgGamePlayNumeric
        {
            public ActionGameContext actionGameContext;
            public GameNumericType gameNumericType;
            public float chgValue;
        }
