...
namespace ET.Client
{
	...
	public class DlgSkillDetailsViewComponent : Entity, IAwake, IDestroy
	{
		...
		public UnityEngine.UI.Button EButton_UpgradeButton
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_UpgradeButton == null )
				{
					this.m_EButton_UpgradeButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "E_Details/info/EButton_Upgrade");
				}
				return this.m_EButton_UpgradeButton;
			}
		}

		public UnityEngine.UI.Image EButton_UpgradeImage
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EButton_UpgradeImage == null )
				{
					this.m_EButton_UpgradeImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "E_Details/info/EButton_Upgrade");
				}
				return this.m_EButton_UpgradeImage;
			}
		}

		public TMPro.TextMeshProUGUI ELable_UpgradeShowTipTextMeshProUGUI
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_ELable_UpgradeShowTipTextMeshProUGUI == null )
				{
					this.m_ELable_UpgradeShowTipTextMeshProUGUI = UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject, "E_Details/info/EButton_Upgrade/ELable_UpgradeShowTip");
				}
				return this.m_ELable_UpgradeShowTipTextMeshProUGUI;
			}
		}
		...
		public void DestroyWidget()
		{
			...
			this.m_EButton_UpgradeButton = null;
			this.m_EButton_UpgradeImage = null;
			this.m_ELable_UpgradeShowTipTextMeshProUGUI = null;
		...
		private UnityEngine.UI.Button m_EButton_UpgradeButton = null;
		private UnityEngine.UI.Image m_EButton_UpgradeImage = null;
		private TMPro.TextMeshProUGUI m_ELable_UpgradeShowTipTextMeshProUGUI = null;
