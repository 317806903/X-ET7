...
namespace ET
{
    ...
    public enum PlayerModelChgType
    {
        ...
        PlayerBackPack_UpgradeItem = 204,

        PlayerBattleCard_AutoSetByBackPack = 300,
        PlayerBattleCard_ReplaceBattleDeckTower = 301,
        PlayerBattleCard_ReplaceBattleDeckMonsterCall = 302,
        PlayerBattleSkill_AutoSetByBackPack = 400,
        PlayerBattleSkill_ReplaceBattleDeck = 401,
