...
namespace ET.Server
{
    public static class TransferHelper
    {
        ...
        public static async ETTask EnterMap(long sceneInstanceId, long playerId, int playerLevel, string gamePlayBattleLevelCfgId, float mapScale)
        {
            await Game.WaitFrameFinish();

			M2M_EnterMapRequest _M2M_EnterMapRequest = new()
            {
                PlayerId = playerId,
