...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        MainLightSelfShadowCasterPass m_MainLightSelfShadowCasterPass;
        ...
        public UniversalRenderer(UniversalRendererData data) : base(data)
        {
            ...
            m_MainLightSelfShadowCasterPass = new MainLightSelfShadowCasterPass(RenderPassEvent.AfterRenderingShadows);
        ...
        internal override void ReleaseRenderTargets()
        {
            ...
            m_MainLightSelfShadowCasterPass?.Dispose();
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if(mainLightShadows)
            {
                m_MainLightSelfShadowCasterPass.Setup(ref renderingData);
            }
            ...
            if (mainLightShadows)
            {
                ...
                EnqueuePass(m_MainLightSelfShadowCasterPass);
            }
