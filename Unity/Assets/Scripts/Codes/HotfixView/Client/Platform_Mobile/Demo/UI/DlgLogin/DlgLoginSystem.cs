...
namespace ET.Client
{
    ...
    public static class DlgLoginSystem
    {
        ...
        public static void PrintSystemInfo(this DlgLogin self)
        {
            ...
            //----------------------------------
            Debug.Log($"--[[ PrintSystemInfo Application.dataPath[{Application.dataPath}]");
            Debug.Log($"--[[ PrintSystemInfo Application.persistentDataPath[{Application.persistentDataPath}]");
            Debug.Log($"--[[ PrintSystemInfo Application.streamingAssetsPath[{Application.streamingAssetsPath}]");
            Debug.Log($"--[[ PrintSystemInfo Application.temporaryCachePath[{Application.temporaryCachePath}]");
