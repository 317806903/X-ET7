...
namespace ET.Client
{
    ...
    public class LoginSceneEnterStart_UI: AEvent<Scene, ClientEventType.EnterLoginSceneStart>
    {
        protected override async ETTask Run(Scene scene, ClientEventType.EnterLoginSceneStart args)
        {
