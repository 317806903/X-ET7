...
namespace ET
{
    public static class UnitSystem
    {
        ...
        public static HashSet<long> GetOwnCaller(this Unit self, bool ownCallActor, bool ownBullet, bool ownAoe, bool ownCallSkillCaster)
        {
            HashSet<long> unitList = ET.Ability.OwnCallerHelper.GetOwnCaller(self, ownCallActor, ownBullet, ownAoe, ownCallSkillCaster);
            return unitList;
        }
        ...
        /// <summary>
        /// 往上找到的第一个的Unit，例如 A1 召唤了 A12， A2 发射了子弹 B1， B1某个时刻再发射的子弹B12
        ///     则 子弹B12通过这个接口可以找到B1
        ///     则 子弹B1通过这个接口可以找到A12
        ///     则 A12通过这个接口可以找到A1
        /// </summary>
        ...
        /// <summary>
        /// 往上找到的第一个的Actor，例如 A1 召唤了 A12， A12 发射了子弹 B1， B1某个时刻再发射的子弹B12
        ///     则 子弹B12通过这个接口可以找到A12
        ///     则 子弹B1通过这个接口可以找到A12
        ///     则 A12通过这个接口可以找到A1
        /// </summary>
        /// <returns></returns>
        public static Unit GetCasterNearActor(this Unit self, bool isContainSelf = true)
        {
            Unit unit = self;
            while (true)
            {
        ...
        /// <summary>
        /// 往上找到的最后的Actor，例如 A1 召唤了 A12， A12 发射了子弹 B1， B1某个时刻再发射的子弹B12
        ///     则 子弹B12通过这个接口可以找到A1
        ///     则 子弹B1通过这个接口可以找到A1
        ///     则 A12通过这个接口可以找到A1
        /// </summary>
        /// <returns></returns>
        public static Unit GetCasterRootActor(this Unit self, bool isContainSelf = true)
        {
            Unit unit = self;
            while (true)
            {
