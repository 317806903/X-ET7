...
namespace ET.Client
{
    ...
    public static class GlobalComponentSystem
    {
        ...
        public static async ETTask Init(this GlobalComponent self)
        {
            ...
            self.InputActionRoot = self.Global.Find("InputAction");
        ...
        public static async ETTask AddComponents(this GlobalComponent self)
        {
            ...
            self.AddComponent<AliyunOSSComponent>();
        }

        public static bool ChkIsUpdateFinished(this GlobalComponent self)
        {
            return self.isUpdateFinished;
        }
