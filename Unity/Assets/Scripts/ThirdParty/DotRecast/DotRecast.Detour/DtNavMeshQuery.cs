...
namespace DotRecast.Detour
{
     ...
     */
        ...
        protected readonly DtNodePool m_nodePool1;
        protected readonly DtNodePool m_nodePool2;
        protected readonly DtNodeQueue m_openList;
        protected DtQueryData m_query;

        List<DtSegInterval> ints_Tmp = new List<DtSegInterval>(16);
        ...
        public DtNavMeshQuery(DtNavMesh nav)
        {
            ...
            m_nodePool1 = new DtNodePool();
            m_nodePool2 = new DtNodePool();
     ...
     */
            ...
            out RcVec3f resultPos, ref List<long> visited)
        {
            ...
            this.m_nodePool1.Clear();
            DtNodePool tinyNodePool = this.m_nodePool1;
            ...
            ref List<long> resultRef, ref List<long> resultParent)
        {
            ...
            this.m_nodePool2.Clear();
            DtNodePool tinyNodePool = this.m_nodePool2;
            ...
            ref List<RcSegmentVert> segmentVerts, ref List<long> segmentRefs)
        {
            ...
            List<DtSegInterval> ints = this.ints_Tmp;
