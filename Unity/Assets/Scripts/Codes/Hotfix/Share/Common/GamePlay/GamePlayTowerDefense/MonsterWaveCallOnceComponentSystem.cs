...
namespace ET
{
    ...
    public static class MonsterWaveCallOnceComponentSystem
    {
        ...
        public static void Init(this MonsterWaveCallOnceComponent self, long playerId, string monsterWaveRuleCfgId, int index, float monsterWaveNumScalePercent, float monsterWaveLevelScalePercent, float waveRewardGoldScalePercent)
        {
            self.playerId = playerId;
            self.monsterWaveRuleCfgId = monsterWaveRuleCfgId;
            ...
            TowerDefense_MonsterWaveCallRuleCfg monsterWaveCallCfg =
                TowerDefense_MonsterWaveCallRuleCfgCategory.Instance.Get(self.monsterWaveRuleCfgId, self.waveIndex);
        ...
        public static void ClearMonsterCallWhenDebug(this MonsterWaveCallOnceComponent self)
        {
            foreach (long unitId in self.monsterWaveUnitList)
            {
