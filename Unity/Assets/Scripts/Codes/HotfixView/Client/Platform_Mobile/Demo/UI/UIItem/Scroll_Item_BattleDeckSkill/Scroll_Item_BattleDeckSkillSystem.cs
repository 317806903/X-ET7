...
namespace ET.Client
{
    [FriendOf(typeof(Scroll_Item_BattleDeckSkill))]
    public static class Scroll_Item_BattleDeckSkillSystem
    {
        public static void RegisterUIEvent(this Scroll_Item_BattleDeckSkill self)
        {
        }

        public static void HideItem(this Scroll_Item_BattleDeckSkill self)
        {
        }

        public static async ETTask Init(this Scroll_Item_BattleDeckSkill self, string itemCfgId, bool needClickShowDetail, bool isLock)
        {
        ...
        public static GameObject GetActionButton(this Scroll_Item_BattleDeckSkill self)
        {
            return self.ES_CommonItem.GetActionButton();
        }

        public static void ShowLock(this Scroll_Item_BattleDeckSkill self, bool isLock)
        {
        ...
        public static void ShowRedDot(this Scroll_Item_BattleDeckSkill self, bool isShowRedDot)
        {
            if (string.IsNullOrEmpty(self.itemCfgId))
            {
