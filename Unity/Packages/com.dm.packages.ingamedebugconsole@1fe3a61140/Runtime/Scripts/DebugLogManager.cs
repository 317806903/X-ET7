...
#pragma warning restore 0649
		...
		private void Update()
		{
			...
			if (EventSystem.current == null)
			{
				...
				{
					this.transform.Find("EventSystem").gameObject.SetActive(true);
				}
			}
		}
#endif
		...
		public void ReceivedLog(DynamicCircularBuffer<QueuedDebugLogEntry> queuedLogEntriesIn)
		{
			while (queuedLogEntriesIn.Count > 0)
			{
				QueuedDebugLogEntry logEntry = queuedLogEntriesIn.RemoveFirst();
