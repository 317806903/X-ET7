...
namespace ET.Client
{
	...
	public static class DlgARRoomPVESystem
	{
        ...
        public static async ETTask<Dictionary<string, int>> GetAllDropItemDic(this DlgARRoomPVE self, int pveLevel, PVELevelDifficulty pveLevelDifficulty)
        {
            PlayerBaseInfoComponent playerBaseInfoComponent =
                await ET.Client.PlayerCacheHelper.GetMyPlayerBaseInfo(self.DomainScene());
            return playerBaseInfoComponent.GetAllDropItemDic(pveLevel, pveLevelDifficulty, true);
        }
        ...
        public static async ETTask GetRoomInfo(this DlgARRoomPVE self)
        {
            ...
            ChallengeLevelCfg challengeLevelCfg =
                TowerDefense_ChallengeLevelCfgCategory.Instance.GetChallengeByIndex(roomComponent.roomTypeInfo.pveIndex, roomComponent.roomTypeInfo.pveLevelDifficulty);
            ...
            var allDropItemDic = await self.GetAllDropItemDic(roomComponent.roomTypeInfo.pveIndex, roomComponent.roomTypeInfo.pveLevelDifficulty);
            self.itemList = new();
        ...
        public static async ETTask AddMonsterItemRefreshListener(this DlgARRoomPVE self, Transform transform, int index)
        {
            ...
            ChallengeLevelCfg challengeLevelCfg =
                TowerDefense_ChallengeLevelCfgCategory.Instance.GetChallengeByIndex(self.pveIndex, self.pveLevelDifficulty);
            List<string> monsterList = challengeLevelCfg.MonsterListShow;
        ...
        public static async ETTask<bool> ChkIsLockPVELevel(this DlgARRoomPVE self, int pveLevel)
        {
            PlayerBaseInfoComponent playerBaseInfoComponent =
                await ET.Client.PlayerCacheHelper.GetMyPlayerBaseInfo(self.DomainScene());
        ...
        public static async ETTask<bool> ChkIsPassPVELevel(this DlgARRoomPVE self, int pveLevel, PVELevelDifficulty pveLevelDifficulty)
        {
            PlayerBaseInfoComponent playerBaseInfoComponent =
                await ET.Client.PlayerCacheHelper.GetMyPlayerBaseInfo(self.DomainScene());
        ...
        public static async ETTask<int> GetLastUnLockPVELevel(this DlgARRoomPVE self)
        {
            PlayerBaseInfoComponent playerBaseInfoComponent =
                await ET.Client.PlayerCacheHelper.GetMyPlayerBaseInfo(self.DomainScene());
