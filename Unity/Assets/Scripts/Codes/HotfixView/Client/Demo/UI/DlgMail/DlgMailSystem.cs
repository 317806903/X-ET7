...
namespace ET.Client
{
    ...
    public static class DlgMailSystem
    {
        ...
        public static void ShowWindow(this DlgMail self, ShowWindowData contextData = null)
        {
        ...
        public static async ETTask RefreshGetAllGiftInMailBox(this DlgMail self)
        {
            ...
            {
                if (mailInfo.Item1.itemCfgList!=null &&(mailInfo.Item2 == MailStatus.UnRead || mailInfo.Item2 == MailStatus.ReadAndNotGetItem))
                {
        ...
        public static async void AddMailListener(this DlgMail self, Transform transform, int index)
        {
