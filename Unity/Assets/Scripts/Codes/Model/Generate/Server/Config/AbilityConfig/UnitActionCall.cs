...
public sealed partial class UnitActionCall: Bright.Config.BeanBase
{
    public UnitActionCall(ByteBuf _buf) 
    {
    ...
    public static UnitActionCall DeserializeUnitActionCall(ByteBuf _buf)
    {
        return new UnitActionCall(_buf);
    }
    ...
    public const int __ID__ = -6697352;
