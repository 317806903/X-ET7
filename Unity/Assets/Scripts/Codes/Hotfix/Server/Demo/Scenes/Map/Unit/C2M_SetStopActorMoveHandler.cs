...
namespace ET.Server
{
	...
	public class C2M_SetStopActorMoveHandler : AMActorLocationHandler<Unit, C2M_SetStopActorMove>
	{
		protected override async ETTask Run(Unit observerUnit, C2M_SetStopActorMove message)
		{
