...
namespace ET.Client
{
    ...
    public class NoticeShowBattleNotice_RefreshDlgBattleTowerNotice: AEvent<Scene, ClientEventType.NoticeShowBattleNotice>
    {
        protected override async ETTask Run(Scene scene, ClientEventType.NoticeShowBattleNotice args)
        {
