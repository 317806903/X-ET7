...
namespace ET.Client
{
    [FriendOf(typeof (UIFollowLeftHandComponent))]
    public static class UIFollowLeftHandComponentSystem
    {
        [ObjectSystem]
        public class UIFollowLeftHandComponentAwakeSystem: AwakeSystem<UIFollowLeftHandComponent>
        {
            protected override void Awake(UIFollowLeftHandComponent self)
            {
            }
        }

        [ObjectSystem]
        public class UIFollowLeftHandComponentDestroySystem: DestroySystem<UIFollowLeftHandComponent>
        {
            protected override void Destroy(UIFollowLeftHandComponent self)
            {
            }
        }

        [ObjectSystem]
        public class UIFollowLeftHandComponentUpdateSystem: UpdateSystem<UIFollowLeftHandComponent>
        {
            protected override void Update(UIFollowLeftHandComponent self)
            {
                self.Update();
            }
        }

        public static void Init(this UIFollowLeftHandComponent self, Transform transUIRoot, Camera mainCamera, Transform leftHandTrans, float3 offset, float rotationXLimit)
        {
            self.transUIRoot = transUIRoot;
            self.MainCamera = mainCamera;
            self.leftHandTrans = leftHandTrans;
            self.offset = offset;
        ...
        public static void Update(this UIFollowLeftHandComponent self)
        {
        ...
        public static void UpdatePos(this UIFollowLeftHandComponent self, bool isQuick)
        {
            float3 pos = self.leftHandTrans.position;
            ...
            {
                Quaternion rotation = self.leftHandTrans.rotation;
        ...
        public static void UpdateRotation(this UIFollowLeftHandComponent self, bool isQuick)
        {
