...
namespace ET.Client
{
	[ComponentOf(typeof(DlgLanguageChoose))]
	[EnableMethod]
	public class DlgLanguageChooseViewComponent : Entity, IAwake, IDestroy
	{
		...
		public UnityEngine.UI.LoopVerticalScrollRect ELoopScrollList_LanguageLoopVerticalScrollRect
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_ELoopScrollList_LanguageLoopVerticalScrollRect == null )
				{
					this.m_ELoopScrollList_LanguageLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject, "EGBackGround/Root/E_Language/ELoopScrollList_Language");
				}
				return this.m_ELoopScrollList_LanguageLoopVerticalScrollRect;
			}
		}
		...
		public void DestroyWidget()
		{
			...
			this.m_ELoopScrollList_LanguageLoopVerticalScrollRect = null;
		...
		private UnityEngine.UI.LoopVerticalScrollRect m_ELoopScrollList_LanguageLoopVerticalScrollRect = null;
