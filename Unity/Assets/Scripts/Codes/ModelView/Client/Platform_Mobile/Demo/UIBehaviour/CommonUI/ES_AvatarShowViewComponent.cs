...
namespace ET.Client
{
	...
	public class ES_AvatarShowViewComponent : Entity, ET.IAwake<UnityEngine.Transform>, IDestroy
	{
		...
		public UnityEngine.UI.Image EboxImage
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_EboxImage == null )
				{
					this.m_EboxImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "Ebox");
				}
				return this.m_EboxImage;
			}
		}
		...
		private UnityEngine.UI.Image m_EboxImage = null;
