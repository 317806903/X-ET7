...
public class DealParticleSystemEditor
{
    [MenuItem("Tools/DealEffectPrefab/Disable All Particle System Collisions")]
    private static void DisableAllParticleSystemCollisions()
    {
