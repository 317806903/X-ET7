...
namespace ET.Client
{
    ...
    public static class DlgGameModeARSystem
    {
        ...
        public static async ETTask UpdatePhysical(this DlgGameModeAR self)
        {
            ...
            self.View.ELabel_PVEPhysicalStrengthTextMeshProUGUI.ShowPhysicalCostText(self.DomainScene(), ET.GamePlayHelper.GetPhysicalCostPVESeason()).Coroutine();
            self.View.ELabel_PVPPhysicalStrengthTextMeshProUGUI.ShowPhysicalCostText(self.DomainScene(), ET.GamePlayHelper.GetPhysicalCostPVPSeason()).Coroutine();
            self.View.ELabel_EndlessPhysicalStrengthTextMeshProUGUI.ShowPhysicalCostText(self.DomainScene(), ET.GamePlayHelper.GetPhysicalCostEndlessChallengeSeason()).Coroutine();
        }
