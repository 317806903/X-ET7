...
namespace ET.Client
{
    ...
    public class NoticeEventLogging_Event: AEvent<Scene, ClientEventType.NoticeEventLogging>
    {
        protected override async ETTask Run(Scene scene, ClientEventType.NoticeEventLogging args)
        {
