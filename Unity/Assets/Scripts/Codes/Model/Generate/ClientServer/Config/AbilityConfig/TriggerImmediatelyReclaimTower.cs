...
/// 回收塔
/// </summary>
public sealed partial class TriggerImmediatelyReclaimTower:  TriggerImmediatelyBase 
{
    public TriggerImmediatelyReclaimTower(ByteBuf _buf)  : base(_buf) 
    {
    ...
    public static TriggerImmediatelyReclaimTower DeserializeTriggerImmediatelyReclaimTower(ByteBuf _buf)
    {
        return new TriggerImmediatelyReclaimTower(_buf);
    }
    ...
    public const int __ID__ = -21315066;
