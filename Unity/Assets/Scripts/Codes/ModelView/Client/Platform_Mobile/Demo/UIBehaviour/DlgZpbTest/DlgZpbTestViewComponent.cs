...
namespace ET.Client
{
	[ComponentOf(typeof(DlgZpbTest))]
	[EnableMethod]
	public class DlgZpbTestViewComponent : Entity, IAwake, IDestroy
	{
		...
		public UnityEngine.UI.Image EImage_Label1Image
		{
			get
			{
				...
				{
					this.m_EImage_Label1Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "EGRoot/EG_MyTowerDesc/EImage_Label1");
				}
		...
		public TMPro.TextMeshProUGUI ELabel_Label1TextMeshProUGUI
		{
			get
			{
				...
				{
					this.m_ELabel_Label1TextMeshProUGUI = UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject, "EGRoot/EG_MyTowerDesc/EImage_Label1/ELabel_Label1");
				}
		...
		public UnityEngine.UI.Image EImage_Label2Image
		{
			get
			{
				...
				{
					this.m_EImage_Label2Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "EGRoot/EG_MyTowerDesc/EImage_Label2");
				}
		...
		public TMPro.TextMeshProUGUI ELabel_Label2TextMeshProUGUI
		{
			get
			{
				...
				{
					this.m_ELabel_Label2TextMeshProUGUI = UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject, "EGRoot/EG_MyTowerDesc/EImage_Label2/ELabel_Label2");
				}
		...
		public UnityEngine.UI.Image EImage_Label3Image
		{
			get
			{
				...
				{
					this.m_EImage_Label3Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "EGRoot/EG_MyTowerDesc/EImage_Label3");
				}
		...
		public TMPro.TextMeshProUGUI ELabel_Label3TextMeshProUGUI
		{
			get
			{
				...
				{
					this.m_ELabel_Label3TextMeshProUGUI = UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject, "EGRoot/EG_MyTowerDesc/EImage_Label3/ELabel_Label3");
				}
