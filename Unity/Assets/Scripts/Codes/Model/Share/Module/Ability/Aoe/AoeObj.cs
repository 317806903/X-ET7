...
namespace ET.Ability
{
    ...
    public class AoeObj: Entity, IAwake, IDestroy, IFixedUpdate
    {
        ...
        ///</summary>
        public List<long> characterInRange = new List<long>();
        ...
        //     if (aoe.model.prefab != "")
        //     {
        //         GameObject aoeEffect = Instantiate<GameObject>(Resources.Load<GameObject>("Prefabs/" + aoe.model.prefab),
        //             new Vector3(),
        //             Quaternion.identity,
        ...
        // {
        //     this.viewContainer.transform.position = new Vector3(viewContainer.transform.position.x,
        //         toY,
