...
/// 塔防(无尽出怪模式)(TeamOne)
/// </summary>
public sealed partial class GamePlayTowerDefenseEndlessChallengeMonsterTeamOne:  GamePlayTowerDefenseBase 
{
    public GamePlayTowerDefenseEndlessChallengeMonsterTeamOne(ByteBuf _buf)  : base(_buf) 
    {
    ...
    public static GamePlayTowerDefenseEndlessChallengeMonsterTeamOne DeserializeGamePlayTowerDefenseEndlessChallengeMonsterTeamOne(ByteBuf _buf)
    {
        return new GamePlayTowerDefenseEndlessChallengeMonsterTeamOne(_buf);
    }
    ...
    public const int __ID__ = -1201809125;
