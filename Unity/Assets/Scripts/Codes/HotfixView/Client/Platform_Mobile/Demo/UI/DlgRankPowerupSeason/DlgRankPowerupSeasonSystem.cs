...
namespace ET.Client
{
    ...
    public static class DlgRankPowerupSeasonSystem
    {
        ...
        public static async ETTask PreLoadWindow(this DlgRankPowerupSeason self, ShowWindowData contextData, Action finished)
        {
            switch (self.pageIndex)
            {
                case 0:
                    await self.View.EPage_Rank.PreLoadWindow();
                    break;
                case 1:
                    await self.View.EPage_Powerup.PreLoadWindow();
                    break;
            }
        ...
        public static void HideWindow(this DlgRankPowerupSeason self)
        {
