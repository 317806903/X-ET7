...
public sealed partial class BuffExistOrder:  SelectObjectOrder 
{
    public BuffExistOrder(ByteBuf _buf)  : base(_buf) 
    {
        BuffDealSelectCondition = BuffDealSelectCondition.DeserializeBuffDealSelectCondition(_buf);
        PostInit();
    }

    public static BuffExistOrder DeserializeBuffExistOrder(ByteBuf _buf)
    {
        return new BuffExistOrder(_buf);
    }
    ...
    public const int __ID__ = 572480362;
