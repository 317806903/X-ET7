...
namespace ET.Client
{
    ...
    public static class DlgMailSystem
    {
        ...
        public static async ETTask SetDrapdownLocalizeText(this DlgMail self)
        {
            ...
            tempData.image = await UIManagerHelper.LoadSpriteAsync("Assets/ResAB/UI/Mail/Mail_icon_expire_01.png");
            ...
            tempData2.image = await UIManagerHelper.LoadSpriteAsync("Assets/ResAB/UI/Mail/Mail_icon_expire_02.png");
            ...
            tempData3.image = await UIManagerHelper.LoadSpriteAsync("Assets/ResAB/UI/Mail/Mail_icon_received_01.png");
            ...
            tempData4.image = await UIManagerHelper.LoadSpriteAsync("Assets/ResAB/UI/Mail/Mail_icon_received_02.png");
