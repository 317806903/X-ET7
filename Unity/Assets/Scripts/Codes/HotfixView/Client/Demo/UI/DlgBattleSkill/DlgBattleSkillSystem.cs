...
namespace ET.Client
{
    [Invoke(TimerInvokeType.DlgBattleSkillFrameTimer)]
    public class DlgBattleSkillTimer : ATimer<DlgBattleSkill>
    {
        protected override void Run(DlgBattleSkill self)
        {
            try
            {
                self.Update();
    ...
    [FriendOf(typeof(DlgBattleSkill))]
	public static class DlgBattleSkillSystem
	{
		public static void RegisterUIEvent(this DlgBattleSkill self)
		{
		...
		public static async ETTask ShowWindow(this DlgBattleSkill self, ShowWindowData contextData = null)
		{
			self.dlgShowTime = TimeHelper.ClientNow();
			await self.RefreshLoopList();
			self.ShowBg();
			self.Timer = TimerComponent.Instance.NewFrameTimer(TimerInvokeType.DlgBattleSkillFrameTimer, self);
		}

		public static bool ChkCanClickBg(this DlgBattleSkill self)
		{
		...
		public static void HideWindow(this DlgBattleSkill self)
		{
		}

		public static async ETTask OnClickBG(this DlgBattleSkill self)
		{
			if(self.ChkCanClickBg())
			{
				return;
			}
			UIManagerHelper.GetUIComponent(self.DomainScene()).HideWindow<DlgBattleSkill>();
			await ETTask.CompletedTask;
		}

		public static async ETTask OnClickQuit(this DlgBattleSkill self)
		{
		...
		public static async ETTask AddSkillBattleDeckItemRefreshListener(this DlgBattleSkill self, Transform transform, int index)
		{
		...
		public static async ETTask AddSkillCardItemRefreshListener(this DlgBattleSkill self, Transform transform, int index)
		{
		...
		public static async ETTask BindMoveItem(this DlgBattleSkill self)
		{
		...
		public static async ETTask ShowMoveItem(this DlgBattleSkill self, (string,bool) skillItemCfg)
		{
		...
		public static async ETTask HideMoveItem(this DlgBattleSkill self)
		{
            Scroll_Item_SkillInfo item = self.skillMoveItem;
		...
		public static async ETTask MovingMoveItem(this DlgBattleSkill self, Vector2 screenPos)
		{
		...
		//刷新循环列表
		public static async ETTask RefreshLoopList(this DlgBattleSkill self)
		{
		...
		//获取除上场外其余技能id
		public static async ETTask<List<(string,bool)>> GetOverageSkillItemCfg(this DlgBattleSkill self)
		{
        ...
        public static void ShowBg(this DlgBattleSkill self)
        {
        ...
        public static void Update(this DlgBattleSkill self)
        {
            if (string.IsNullOrEmpty(self.moveItemCfgId))
            {
                return;
        ...
        public static async ETTask ChkPointUp(this DlgBattleSkill self)
        {
