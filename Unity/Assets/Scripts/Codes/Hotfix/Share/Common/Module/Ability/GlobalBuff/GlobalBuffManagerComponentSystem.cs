...
namespace ET.Ability
{
    public static class GlobalBuffManagerComponentSystem
    {
        ...
        public static async ETTask AddGlobalBuff_Game(this GlobalBuffManagerComponent self, TeamFlagType teamFlagType, long casterPlayerId, string homeTeamGlobalBuffCfgId)
        {
            GlobalBuffGameComponent globalBuffGameComponent = self.GetComponent<GlobalBuffGameComponent>();
            await globalBuffGameComponent.AddGlobalBuff(teamFlagType, casterPlayerId, homeTeamGlobalBuffCfgId);
        }
