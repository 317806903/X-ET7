...
{
	[EnableMethod]
	public class Scroll_Item_RankEndlessChallenge : Entity, IAwake, IDestroy, IUIScrollItem, IUILogic
	{
		...
		public UnityEngine.UI.Image Eimage_MyBGImage
		{
			get
			{
				...
				if (this.isCacheNode)
				{
					...
					{
						this.m_Eimage_MyBGImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "ItemBG/Eimage_MyBG");
					}
					return this.m_Eimage_MyBGImage;
				}
				else
				{
					return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "ItemBG/Eimage_MyBG");
				}
			}
		}
		...
		public UnityEngine.UI.Image EImage_NO1Image
		{
			get
			{
				...
				if (this.isCacheNode)
				{
					...
					{
						this.m_EImage_NO1Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "ItemBG/EImage_NO1");
					}
					return this.m_EImage_NO1Image;
				}
				else
				{
					return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "ItemBG/EImage_NO1");
				}
			}
		}
		...
		public UnityEngine.UI.Image EImage_NO2Image
		{
			get
			{
				...
				if (this.isCacheNode)
				{
					...
					{
						this.m_EImage_NO2Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "ItemBG/EImage_NO2");
					}
					return this.m_EImage_NO2Image;
				}
				else
				{
					return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "ItemBG/EImage_NO2");
				}
			}
		}
		...
		public UnityEngine.UI.Image EImage_NO3Image
		{
			get
			{
				...
				if (this.isCacheNode)
				{
					...
					{
						this.m_EImage_NO3Image = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "ItemBG/EImage_NO3");
					}
					return this.m_EImage_NO3Image;
				}
				else
				{
					return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "ItemBG/EImage_NO3");
				}
			}
		}
