...
namespace ET
{
    ...
    public static class GamePlayStatisticalDataComponentSystem
    {
        ...
        {
            Unit attackerActorUnit = attackerUnit.GetCasterRootActor();
        ...
        public static void AddMonsterEscapeInfo(this GamePlayStatisticalDataComponent self, int attackValue)
        {
            self.playerMonsterEscapeAttackValue += attackValue;
        }
        ...
        public static void AddTowerKillMonsterInfo(this GamePlayStatisticalDataComponent self, Unit attackerUnit, Unit beKillUnit)
        {
            ...
            if (string.IsNullOrEmpty(monsterCfgId))
            {
                return;
            }
        ...
        public static int GetPlayerMonsterEscapeAttackValue(this GamePlayStatisticalDataComponent self)
        {
            return self.playerMonsterEscapeAttackValue;
        }
