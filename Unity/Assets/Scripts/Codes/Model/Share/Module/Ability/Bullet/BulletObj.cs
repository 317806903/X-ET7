...
namespace ET.Ability
{
    ...
    public class BulletObj: Entity, IAwake, IDestroy
    {
        ...
        ///本帧的移动
        ///</summary>
        private float3 moveForce = new float3();
        ...
        ///</summary>
        public long followingTargetUnitId;
        ...
        //     {
        //         GameObject bulletEffect = Instantiate<GameObject>(Resources.Load<GameObject>("Prefabs/Bullet/" + bullet.model.prefab),
        //             new Vector3(),
        //             Quaternion.identity,
        ...
        // {
        //     hitRecords.Add(new BulletHitRecord(target,
