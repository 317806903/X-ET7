...
namespace ET.Client
{
	...
	public static class ARSessionComponentSystem
	{
		...
		public static string GetARSceneMeshId(this ARSessionComponent self)
		{
			return self.GetARSceneId();
		}
		...
		public static GameObject GetSceneMeshObj(this ARSessionComponent self)
		{
			return null;
		}

		public static void SetSceneMeshObj(this ARSessionComponent self, Mesh mesh)
		{
		}

		public static Transform GetSpatialAnchorTransform(this ARSessionComponent self)
		{
			return null;
		}

		public static Vector3 GetSpatialAnchorPosition(this ARSessionComponent self)
		{
			return Vector3.zero;
		}

		public static Quaternion GetSpatialAnchorRotation(this ARSessionComponent self)
		{
