...
public sealed partial class AoeActionCall: Bright.Config.BeanBase
{
    public AoeActionCall(ByteBuf _buf) 
    {
    ...
    public static AoeActionCall DeserializeAoeActionCall(ByteBuf _buf)
    {
        return new AoeActionCall(_buf);
    }

    /// <summary>
    /// 触发事件
    /// </summary>
    public AoeTriggerEvent AoeTrig { get; private set; }
    /// <summary>
    /// 延迟多久后触发action
    /// </summary>
