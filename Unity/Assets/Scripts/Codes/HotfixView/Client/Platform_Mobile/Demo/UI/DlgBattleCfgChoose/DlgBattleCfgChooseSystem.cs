...
namespace ET.Client
{
	...
	public static class DlgBattleCfgChooseSystem
	{
		...
		public static void HideWindow(this DlgBattleCfgChoose self)
		{
        ...
        public static void AddItemRefreshListener(this DlgBattleCfgChoose self, Transform transform, int index)
        {
            ...
            itemGameCfgItem.E_Text_LevelTextMeshProUGUI.text = list[index].Id;
        ...
        public static async ETTask OnSure(this DlgBattleCfgChoose self)
        {
            ...
            EventSystem.Instance.Publish(self.DomainScene(), new ClientEventType.BattleCfgIdChoose()
            {
        ...
        public static bool ChkGameMode(this DlgBattleCfgChoose self, GamePlayBattleLevelCfg gamePlayBattleLevelCfg, int gameModeIndex)
        {
	        ...
	        if (gameMode[0] == "-1")
	        {
		        isMatching = true;
	                 ...
	                 || gamePlayBattleLevelCfg.GamePlayMode is GamePlayTowerDefenseNormalTeamOne))
	        {
		        isMatching = true;
	        }
