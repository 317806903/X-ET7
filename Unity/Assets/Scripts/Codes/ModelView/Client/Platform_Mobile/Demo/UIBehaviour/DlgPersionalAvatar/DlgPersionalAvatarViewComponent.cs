...
namespace ET.Client
{
	...
	public class DlgPersionalAvatarViewComponent : Entity, IAwake, IDestroy
	{
		...
		public UITextLocalizeMonoView ELabel_NoFrameTipUITextLocalizeMonoView
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_ELabel_NoFrameTipUITextLocalizeMonoView == null )
				{
					this.m_ELabel_NoFrameTipUITextLocalizeMonoView = UIFindHelper.FindDeepChild<UITextLocalizeMonoView>(this.uiTransform.gameObject, "EGBackGround/Root/E_info/Frame/ELabel_NoFrameTip");
				}
				return this.m_ELabel_NoFrameTipUITextLocalizeMonoView;
			}
		}
		...
		public UITextLocalizeMonoView ELabel_CurrentUITextLocalizeMonoView
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_ELabel_CurrentUITextLocalizeMonoView == null )
				{
					this.m_ELabel_CurrentUITextLocalizeMonoView = UIFindHelper.FindDeepChild<UITextLocalizeMonoView>(this.uiTransform.gameObject, "EGBackGround/Root/EImageCurrentBk/ELabel_Current");
				}
				return this.m_ELabel_CurrentUITextLocalizeMonoView;
			}
		}
		...
		public UITextLocalizeMonoView ELabel_PreviewUITextLocalizeMonoView
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_ELabel_PreviewUITextLocalizeMonoView == null )
				{
					this.m_ELabel_PreviewUITextLocalizeMonoView = UIFindHelper.FindDeepChild<UITextLocalizeMonoView>(this.uiTransform.gameObject, "EGBackGround/Root/EImageCurrentBk/ELabel_Preview");
				}
				return this.m_ELabel_PreviewUITextLocalizeMonoView;
			}
		}
		...
		public UITextLocalizeMonoView ELabelDesNOFrameUITextLocalizeMonoView
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_ELabelDesNOFrameUITextLocalizeMonoView == null )
				{
					this.m_ELabelDesNOFrameUITextLocalizeMonoView = UIFindHelper.FindDeepChild<UITextLocalizeMonoView>(this.uiTransform.gameObject, "EGBackGround/Root/EImageCurrentBk/ELabelDesNOFrame");
				}
				return this.m_ELabelDesNOFrameUITextLocalizeMonoView;
			}
		}
		...
		public void DestroyWidget()
		{
			...
			this.m_ELabel_NoFrameTipUITextLocalizeMonoView = null;
			...
			this.m_ELabel_CurrentUITextLocalizeMonoView = null;
			this.m_ELabel_PreviewTextMeshProUGUI = null;
			this.m_ELabel_PreviewUITextLocalizeMonoView = null;
			this.m_ELabelDesFrameTextMeshProUGUI = null;
			this.m_ELabelDesNOFrameTextMeshProUGUI = null;
			this.m_ELabelDesNOFrameUITextLocalizeMonoView = null;
		...
		private UITextLocalizeMonoView m_ELabel_NoFrameTipUITextLocalizeMonoView = null;
		...
		private UITextLocalizeMonoView m_ELabel_CurrentUITextLocalizeMonoView = null;
		private TMPro.TextMeshProUGUI m_ELabel_PreviewTextMeshProUGUI = null;
		private UITextLocalizeMonoView m_ELabel_PreviewUITextLocalizeMonoView = null;
		...
		private UITextLocalizeMonoView m_ELabelDesNOFrameUITextLocalizeMonoView = null;
