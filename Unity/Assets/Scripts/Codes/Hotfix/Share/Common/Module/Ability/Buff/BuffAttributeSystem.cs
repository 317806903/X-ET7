...
namespace ET.Ability
{
    ...
    public static class BuffAttributeSystem
    {
        ...
        public static bool ChgBuffStackCountWhenModifyAttribute(this BuffObj self, BuffActionModifyAttribute buffActionModifyAttribute, int oldStackCount, int newStackCount)
        {
            if (oldStackCount == 0)
            {
                return false;
