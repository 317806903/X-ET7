...
public partial class UICodeSpawner
{
    ...
    static void SpawnCodeForPageUISystem(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Demo/UI/UIPage/" + strDlgName;
        ...
        strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Demo/UI/UIPage/" + strDlgName + "/" + strDlgName + "System.cs";
    ...
    {
        string strDlgName = gameObject.name;
        string strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Demo/UI/UIPage/" + strDlgName;
        ...
        strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Demo/UI/UIPage/" + strDlgName + "/" + strDlgName + ".cs";
        if (System.IO.File.Exists(strFilePath))
        {
    ...
    static void SpawnCodeForPageUI(GameObject objPanel)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Demo/UIBehaviour/UIPage" +
                             "";
        ...
        strFilePath     = Application.dataPath + "/Scripts/Codes/HotfixView/Client/Demo/UIBehaviour/UIPage/" + strDlgName + "ViewSystem.cs";
    ...
    static void SpawnCodeForPageUIViewBehaviour(GameObject objPanel)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Demo/UIBehaviour/UIPage";

        if ( !System.IO.Directory.Exists(strFilePath) )
        {
            System.IO.Directory.CreateDirectory(strFilePath);
        }
        strFilePath = Application.dataPath + "/Scripts/Codes/ModelView/Client/Demo/UIBehaviour/UIPage/" + strDlgComponentName + ".cs";
