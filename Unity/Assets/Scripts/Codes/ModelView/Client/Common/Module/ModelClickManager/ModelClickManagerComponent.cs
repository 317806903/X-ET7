...
namespace ET.Client
{
    ...
    public class ModelClickManagerComponent: Entity, IAwake, IDestroy, IUpdate
    {
        ...
        public Dictionary<GameObject, Action> ModelClickCallBackDic;
        public Dictionary<GameObject, Action> ModelPressCallBackDic;
        ...
        public float chkClearTime;
        public List<GameObject> keysToRemove = new();
    }
}