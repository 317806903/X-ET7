    ...
    public static class RoomHelper
    {
        ...
        public static async ETTask GetRoomListAsync(Scene clientScene, bool needARRoom, bool needNotARRoom)
        {
            try
            {
                ...
                if (_G2C_GetRoomList.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_GetRoomList.Message});
                }
                else
                {
        ...
        public static async ETTask<(bool, RoomComponent)> GetRoomInfoAsync(Scene clientScene, long roomId)
        {
            ...
            if (_G2C_GetRoomInfo.Error != ET.ErrorCode.ERR_Success)
            {
                ...
                EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_GetRoomInfo.Message});
                return (false, null);
            }
            else
            {
        ...
        public static async ETTask<(bool bRet, long roomId)> CreateRoomAsync(Scene clientScene, RoomTypeInfo roomTypeInfo)
        {
            try
            {
                ...
                if (_G2C_CreateRoom.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_CreateRoom.Message});
                    return (false, 0);
                }
        ...
        public static async ETTask<bool> JoinRoomAsync(Scene clientScene, long roomId)
        {
            ...
            try
            {
                ...
                if (_G2C_JoinRoom.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_JoinRoom.Message});
                    return false;
                }
        ...
        public static async ETTask QuitRoomAsync(Scene clientScene)
        {
            try
            {
                ...
                if (_G2C_QuitRoom.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_QuitRoom.Message});
                }
            }
            catch (Exception e)
            {
        ...
        public static async ETTask ChgRoomMemberStatusAsync(Scene clientScene, bool isReady)
        {
            try
            {
                ...
                G2C_ChgRoomMemberStatus _G2C_ChgRoomMemberStatus =
                    await ET.Client.SessionHelper.GetSession(clientScene).Call(new C2G_ChgRoomMemberStatus() { IsReady = isReady? 1 : 0, }) as
                        G2C_ChgRoomMemberStatus;
                if (_G2C_ChgRoomMemberStatus.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_ChgRoomMemberStatus.Message});
                }
            }
            catch (Exception e)
            {
        ...
        public static async ETTask ChgRoomMemberSeatAsync(Scene clientScene, int newSeat)
        {
            try
            {
                ...
                if (_G2C_ChgRoomMemberSeat.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_ChgRoomMemberSeat.Message});
                }
            }
            catch (Exception e)
            {
        ...
        public static async ETTask ChgRoomMemberTeamAsync(Scene clientScene, RoomTeamId newTeam)
        {
            try
            {
                ...
                if (_G2C_ChgRoomMemberTeam.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_ChgRoomMemberTeam.Message});
                }
            }
            catch (Exception e)
            {
        ...
        public static async ETTask<bool> SetARRoomInfoAsync(Scene clientScene, float arMapScale, ARMeshType arMeshType, string arSceneId, string arSceneMeshId, string arMeshDownLoadUrl, byte[] arMeshBytes)
        {
            try
            {
                ...
                if (_G2C_SetARRoomInfo.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_SetARRoomInfo.Message});
                    return false;
                }
        ...
        public static async ETTask<(float arMapScale, ARMeshType arMeshType, string arSceneId, string arSceneMeshId, string arMeshDownLoadUrl, byte[] arMeshBytes)> GetARRoomInfoAsync(Scene clientScene, long roomId, bool isWithARMeshBytes)
        {
            if (roomId == 0)
            {
                return default;
            ...
            try
            {
                G2C_GetARRoomInfo _G2C_GetARRoomInfo = await ET.Client.SessionHelper.GetSession(clientScene).Call(new
                    C2G_GetARRoomInfo()
                    {
                        RoomId = roomId,
                        IsWithARMeshBytes = isWithARMeshBytes?1:0,
                    }) as G2C_GetARRoomInfo;
                if (_G2C_GetARRoomInfo.Error != ET.ErrorCode.ERR_Success)
                {
                    Log.Error($"ET.Client.RoomHelper.GetARRoomInfoAsync Error==1 msg={_G2C_GetARRoomInfo.Message}");
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_GetARRoomInfo.Message});
                    return default;
                }

                return (_G2C_GetARRoomInfo.ARMapScale * 0.01f, (ARMeshType)_G2C_GetARRoomInfo.ARMeshType,
                    _G2C_GetARRoomInfo.ARSceneId,_G2C_GetARRoomInfo.ARSceneMeshId,
                    _G2C_GetARRoomInfo.ARMeshDownLoadUrl, _G2C_GetARRoomInfo.ARMeshBytes);
            }
            catch (Exception e)
            {
                Log.Error(e);
        ...
        public static async ETTask ChgRoomBattleLevelCfgAsync(Scene clientScene, RoomTypeInfo roomTypeInfo)
        {
            try
            {
                ...
                if (_G2C_ChgRoomBattleLevelCfg.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_ChgRoomBattleLevelCfg.Message});
                }
            }
            catch (Exception e)
            {
        ...
        public static async ETTask MemberQuitBattleAsync(Scene clientScene)
        {
            try
            {
                ...
                if (_M2C_MemberQuitBattle.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _M2C_MemberQuitBattle.Message});
                }
            }
            catch (Exception e)
            {
        ...
        public static async ETTask KickMemberOutRoomAsync(Scene clientScene, long beKickedPlayerId)
        {
            try
            {
                ...
                if (_G2C_KickMemberOutRoom.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_KickMemberOutRoom.Message});
                }
            }
            catch (Exception e)
            {
        ...
        public static async ETTask ReturnBackBattle(Scene clientScene)
        {
            try
            {
                ...
                if (_G2C_ReturnBackBattle.Error != ET.ErrorCode.ERR_Success)
                {
                    ...
                    EventSystem.Instance.Publish(clientScene, new ClientEventType.NoticeUITip(){tipMsg = _G2C_ReturnBackBattle.Message});
                }
            }
            catch (Exception e)
            {
