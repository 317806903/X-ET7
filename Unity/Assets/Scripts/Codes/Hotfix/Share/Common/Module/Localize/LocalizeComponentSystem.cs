...
namespace ET
{
    ...
    public static class LocalizeComponentSystem
    {
        ...
        public static void SwitchLanguage(this LocalizeComponent self, LanguageType language, bool forceSet)
        {
            ...
            EventSystem.Instance.Publish(self.DomainScene(), new ClientEventType.SwitchLanguage() {languageType = language});
        ...
        public static void ResetLanguage(this LocalizeComponent self)
        {
            ...
            EventSystem.Instance.Publish(self.DomainScene(), new ClientEventType.SwitchLanguage() {languageType = self.CurrentLanguage});
