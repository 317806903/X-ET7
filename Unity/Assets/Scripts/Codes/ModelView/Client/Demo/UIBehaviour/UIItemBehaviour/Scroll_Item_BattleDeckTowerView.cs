...
{
	[EnableMethod]
	public partial class Scroll_Item_BattleDeckTower : Entity, IAwake, IDestroy, IUIScrollItem, IUILogic
	{
		...
		public Scroll_Item_BattleDeckTower BindTrans(Transform trans)
		{
