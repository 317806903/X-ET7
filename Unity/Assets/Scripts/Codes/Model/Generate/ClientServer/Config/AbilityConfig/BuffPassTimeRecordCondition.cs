...
public sealed partial class BuffPassTimeRecordCondition:  UnitConditionBase 
{
    ...
    public static BuffPassTimeRecordCondition DeserializeBuffPassTimeRecordCondition(ByteBuf _buf)
    {
        return new BuffPassTimeRecordCondition(_buf);
    }
    ...
    public const int __ID__ = 2053644153;
