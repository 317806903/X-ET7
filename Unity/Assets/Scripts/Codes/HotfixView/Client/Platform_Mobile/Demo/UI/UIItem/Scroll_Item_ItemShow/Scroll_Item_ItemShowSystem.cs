...
namespace ET.Client
{
    ...
    public static class Scroll_Item_ItemShowSystem
    {
        ...
        public static async ETTask Init(this Scroll_Item_ItemShow self, string itemCfgId, bool needClickShowDetail, int num = 0, bool isNeedChoose = false)
        {
            EUIRootHelper.ResetRendererSortingOrder(self.uiTransform.gameObject);
