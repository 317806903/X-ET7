...
namespace ET
{
    ...
    public static class SyncDataManagerSystem
    {
        ...
        {
            self.AddComponent<SyncDataManager_UnitBaseInfo>();
        ...
        {
            self.GetComponent<SyncDataManager_UnitBaseInfo>().FixedUpdate(fixedDeltaTime);
        ...
        public static void AddSyncData_UnitBaseInfo(this SyncDataManager self, Unit unit)
        {
            self.GetComponent<SyncDataManager_UnitBaseInfo>().AddSyncPosUnit(unit);
        }
