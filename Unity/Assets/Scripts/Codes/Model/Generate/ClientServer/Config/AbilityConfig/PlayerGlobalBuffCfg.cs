...
public sealed partial class PlayerGlobalBuffCfg: Bright.Config.BeanBase
{
    public PlayerGlobalBuffCfg(ByteBuf _buf) 
    {
        Id = _buf.ReadString();
    ...
    public static PlayerGlobalBuffCfg DeserializePlayerGlobalBuffCfg(ByteBuf _buf)
    {
        return new PlayerGlobalBuffCfg(_buf);
    }
    ...
    public const int __ID__ = 1404636269;
