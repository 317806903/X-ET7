...
public sealed partial class ChkSelectUnitNumRecordCondition:  UnitConditionBase 
{
    ...
    public static ChkSelectUnitNumRecordCondition DeserializeChkSelectUnitNumRecordCondition(ByteBuf _buf)
    {
        return new ChkSelectUnitNumRecordCondition(_buf);
    }

    public RecordKeyInt RecordKey { get; private set; }

    public const int __ID__ = 1074621386;
