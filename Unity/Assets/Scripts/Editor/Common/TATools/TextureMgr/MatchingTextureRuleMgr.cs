...
namespace TATools.TextureFormatSetting
{
    public class MatchingTextureRuleMgr
    {
        ...
        private void Init()
        {
            ...
            this._AddMatchingRule("*", "*@NotDeal", "*", _TexSize_1024, true, TextureCatalog.NotDeal);
            ...
            this._AddMatchingRule("^Assets/ResAB/UI3D/", "*", "*.png", _TexSize_2048, false, TextureCatalog.UI3DAltasSpriteRGBA);

            this._AddMatchingRule("^Assets/ResAB/UI3D_MultiLanguage/", "*", "*.png", _TexSize_2048, false, TextureCatalog.UI3DAltasSpriteRGBA);
            ...
            this._AddMatchingRule("*", "Cube_*@1024", "*.exr", _TexSize_1024, false, TextureCatalog.Cube256_EXR);
            this._AddMatchingRule("*", "*Probe*", "*.exr", _TexSize_1024, false, TextureCatalog.Cube256_EXR);
