...
public sealed partial class SelectObjectCfg: Bright.Config.BeanBase
{
    public SelectObjectCfg(ByteBuf _buf) 
    {
        Id = _buf.ReadString();
    ...
    public static SelectObjectCfg DeserializeSelectObjectCfg(ByteBuf _buf)
    {
        return new SelectObjectCfg(_buf);
    }
