...
public partial class UICodeSpawner
{
    ...
    static void SpawnCodeForSubUISystem(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + $"/Scripts/Codes/HotfixView/Client/{UICodeSpawner.GetPlatform()}/Demo/UI/UICommon/" + strDlgName;
        ...
        strFilePath = Application.dataPath + $"/Scripts/Codes/HotfixView/Client/{UICodeSpawner.GetPlatform()}/Demo/UI/UICommon/" + strDlgName + "/" + strDlgName + "System.cs";
    ...
    {
        string strDlgName = gameObject.name;
        string strFilePath = Application.dataPath + $"/Scripts/Codes/ModelView/Client/{UICodeSpawner.GetPlatform()}/Demo/UI/UISubUI/" + strDlgName;
        ...
        strFilePath = Application.dataPath + $"/Scripts/Codes/ModelView/Client/{UICodeSpawner.GetPlatform()}/Demo/UI/UISubUI/" + strDlgName + "/" + strDlgName + ".cs";
        if (System.IO.File.Exists(strFilePath))
        {
    ...
    static void SpawnCodeForSubUI(GameObject objPanel)
    {
        ...
        string strFilePath = Application.dataPath + $"/Scripts/Codes/HotfixView/Client/{UICodeSpawner.GetPlatform()}/Demo/UIBehaviour/CommonUI" +
                             "";
        ...
        strFilePath     = Application.dataPath + $"/Scripts/Codes/HotfixView/Client/{UICodeSpawner.GetPlatform()}/Demo/UIBehaviour/CommonUI/" + strDlgName + "ViewSystem.cs";
    ...
    static void SpawnCodeForSubUIViewBehaviour(GameObject objPanel)
    {
        ...
        string strFilePath = Application.dataPath + $"/Scripts/Codes/ModelView/Client/{UICodeSpawner.GetPlatform()}/Demo/UIBehaviour/CommonUI";

        if ( !System.IO.Directory.Exists(strFilePath) )
        {
            System.IO.Directory.CreateDirectory(strFilePath);
        }
        strFilePath = Application.dataPath + $"/Scripts/Codes/ModelView/Client/{UICodeSpawner.GetPlatform()}/Demo/UIBehaviour/CommonUI/" + strDlgComponentName + ".cs";
