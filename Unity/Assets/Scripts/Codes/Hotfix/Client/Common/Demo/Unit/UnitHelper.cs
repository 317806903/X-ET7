...
namespace ET.Client
{
    public static class UnitHelper
    {
        ...
        public static float GetMaxSkillDis(Unit unit)
        {
            ...
            if (skillDis > maxAttackDis && maxAttackDis > 0)
            {
                skillDis = maxAttackDis;
            }
            float clientResScale = ET.Ability.UnitHelper.GetClientGameResScale(unit.DomainScene());
            skillDis *= clientResScale;
