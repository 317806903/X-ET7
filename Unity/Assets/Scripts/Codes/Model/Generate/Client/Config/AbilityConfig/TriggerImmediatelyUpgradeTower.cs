...
/// 升级塔
/// </summary>
public sealed partial class TriggerImmediatelyUpgradeTower:  TriggerImmediatelyBase 
{
    public TriggerImmediatelyUpgradeTower(ByteBuf _buf)  : base(_buf) 
    {
    ...
    public static TriggerImmediatelyUpgradeTower DeserializeTriggerImmediatelyUpgradeTower(ByteBuf _buf)
    {
        return new TriggerImmediatelyUpgradeTower(_buf);
    }
    ...
    public const int __ID__ = -1338125901;
