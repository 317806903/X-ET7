...
/// 塔防(单人闯关模式)
/// </summary>
public sealed partial class GamePlayTowerDefensePVE:  GamePlayModeBase 
{
    public GamePlayTowerDefensePVE(ByteBuf _buf)  : base(_buf) 
    {
        GamePlayModeCfgId = _buf.ReadString();
        PostInit();
    }

    public static GamePlayTowerDefensePVE DeserializeGamePlayTowerDefensePVE(ByteBuf _buf)
    {
        return new GamePlayTowerDefensePVE(_buf);
    }
    ...
    public const int __ID__ = -1245231774;
