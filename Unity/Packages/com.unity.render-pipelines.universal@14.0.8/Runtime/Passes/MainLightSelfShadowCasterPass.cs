...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    /// </summary>
    public class MainLightSelfShadowCasterPass : ScriptableRenderPass
    {
        ...
        int m_MainLightSelfShadowmapID;
        internal RTHandle m_MainLightSelfShadowmapTexture;
        internal RTHandle m_EmptyLightSelfShadowmapTexture;
        ...
        ProfilingSampler m_ProfilingSetupSampler = new ProfilingSampler("Setup Self Shadowmap");

        /// <summary>
        /// Creates a new <c>MainLightSelfShadowCasterPass</c> instance.
        /// </summary>
        /// <param name="evt">The <c>RenderPassEvent</c> to use.</param>
        /// <seealso cref="RenderPassEvent"/>
        public MainLightSelfShadowCasterPass(RenderPassEvent evt)
        {
            base.profilingSampler = new ProfilingSampler(nameof(MainLightSelfShadowCasterPass));
            renderPassEvent = evt;
            ...
            m_MainLightSelfShadowmapID = Shader.PropertyToID("_MainLightSelfShadowmapTexture");
            m_EmptyLightSelfShadowmapTexture = ShadowUtils.AllocShadowRT(1, 1, k_ShadowmapBufferBits, 1, 0, name: "_EmptyLightSelfShadowmapTexture");
        }
        ...
        public void Dispose()
        {
            m_MainLightSelfShadowmapTexture?.Release();
            m_EmptyLightSelfShadowmapTexture?.Release();
        }
        ...
        public bool Setup(ref RenderingData renderingData)
        {
            ...
            ShadowUtils.ShadowRTReAllocateIfNeeded(ref m_MainLightSelfShadowmapTexture, renderTargetWidth, renderTargetHeight, k_ShadowmapBufferBits, name: "_MainLightShadowmapTexture");

            m_MaxShadowDistanceSq = renderingData.cameraData.maxShadowDistance * renderingData.cameraData.maxShadowDistance;
            m_CascadeBorder = renderingData.shadowData.mainLightShadowCascadeBorder;
            m_CreateEmptyShadowmap = false;
            useNativeRenderPass = true;
            ShadowUtils.ShadowRTReAllocateIfNeeded(ref m_EmptyLightSelfShadowmapTexture, 1, 1, k_ShadowmapBufferBits, name: "_EmptyLightShadowmapTexture");
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            if (m_CreateEmptyShadowmap)
                ConfigureTarget(m_EmptyLightSelfShadowmapTexture);
            else
                ConfigureTarget(m_MainLightSelfShadowmapTexture);
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            if (m_CreateEmptyShadowmap)
            {
                ...
                renderingData.commandBuffer.SetGlobalTexture(m_MainLightSelfShadowmapID, m_EmptyLightSelfShadowmapTexture.nameID);

                return;
            }
            if(renderingData.cameraData.camera.TryGetCullingParameters(out var cullingParameters))
            {
                int terrain = LayerMask.NameToLayer("Map");
            ...
            // RenderMainLightCascadeShadowmap(ref context, ref renderingData);
            renderingData.commandBuffer.SetGlobalTexture(m_MainLightSelfShadowmapID, m_MainLightSelfShadowmapTexture.nameID);
        }
        ...
        void SetEmptyMainLightCascadeShadowmap(ref ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.SetGlobalVector(MainLightShadowConstantBuffer._ShadowmapSize,
                new Vector4(1f / m_EmptyLightSelfShadowmapTexture.rt.width, 1f / m_EmptyLightSelfShadowmapTexture.rt.height, m_EmptyLightSelfShadowmapTexture.rt.width, m_EmptyLightSelfShadowmapTexture.rt.height));
        ...
        {
            internal MainLightSelfShadowCasterPass pass;
        ...
        internal TextureHandle Render(RenderGraph graph, ref RenderingData renderingData)
        {
            ...
            using (var builder = graph.AddRenderPass<PassData>("Main Light Self Shadowmap", out var passData, base.profilingSampler))
            {
                InitPassData(ref passData, ref renderingData, ref graph);

                if (!m_CreateEmptyShadowmap)
                {
                    passData.shadowmapTexture = UniversalRenderer.CreateRenderGraphTexture(graph, m_MainLightSelfShadowmapTexture.rt.descriptor, "Main Shadowmap", true, ShadowUtils.m_ForceShadowPointSampling ? FilterMode.Point : FilterMode.Bilinear);
            ...
            using (var builder = graph.AddRenderPass<PassData>("Set Main Self Shadow Globals", out var passData, base.profilingSampler))
            {
                InitPassData(ref passData, ref renderingData, ref graph);
        ...
        void InitPassData(ref PassData passData, ref RenderingData renderingData, ref RenderGraph graph)
        {
            ...
            passData.shadowmapID = m_MainLightSelfShadowmapID;
