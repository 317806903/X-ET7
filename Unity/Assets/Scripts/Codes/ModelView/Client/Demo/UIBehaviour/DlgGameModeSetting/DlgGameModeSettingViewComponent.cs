	...
	public class DlgGameModeSettingViewComponent : Entity, IAwake, IDestroy
	{
		...
		public UnityEngine.UI.Button E_ButtonTutorialsButton
		{
			get
			{
				...
				{
					this.m_E_ButtonTutorialsButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "EGBackGround/Root/E_Other/E_ButtonTutorials");
				}
		...
		public UnityEngine.UI.Image E_ButtonTutorialsImage
		{
			get
			{
				...
				{
					this.m_E_ButtonTutorialsImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "EGBackGround/Root/E_Other/E_ButtonTutorials");
				}
		...
		public UnityEngine.UI.Button E_PrivacyPolicyButton
		{
			get
			{
				...
				{
					this.m_E_PrivacyPolicyButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "EGBackGround/Root/E_Other/E_PrivacyPolicy");
				}
		...
		public UnityEngine.UI.Image E_PrivacyPolicyImage
		{
			get
			{
				...
				{
					this.m_E_PrivacyPolicyImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "EGBackGround/Root/E_Other/E_PrivacyPolicy");
				}
		...
		public UnityEngine.UI.Button E_DiscordButton
		{
			get
			{
				...
				{
					this.m_E_DiscordButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "EGBackGround/Root/E_Other/E_Discord");
				}
		...
		public UnityEngine.UI.Image E_DiscordImage
		{
			get
			{
				...
				{
					this.m_E_DiscordImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "EGBackGround/Root/E_Other/E_Discord");
				}
