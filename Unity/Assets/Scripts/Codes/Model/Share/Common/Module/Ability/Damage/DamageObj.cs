...
namespace ET.Ability
{
    ...
    public class DamageObj: Entity, IAwake, IDestroy
    {
        public string damageUnitCfgId;
        [BsonIgnore]
        public ActionCfg_DamageUnit model
        {
            get
            {
                return ActionCfg_DamageUnitCategory.Instance.Get(this.damageUnitCfgId);
            }
        }
