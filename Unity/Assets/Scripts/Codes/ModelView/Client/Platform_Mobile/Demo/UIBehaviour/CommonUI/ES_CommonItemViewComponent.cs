...
namespace ET.Client
{
	...
	public class ES_CommonItemViewComponent : Entity, ET.IAwake<UnityEngine.Transform>, IDestroy
	{
		...
		public UnityEngine.UI.Image E_ItemMarkIconImage
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_E_ItemMarkIconImage == null )
				{
					this.m_E_ItemMarkIconImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "EG_Show/E_ItemMarkIcon");
				}
				return this.m_E_ItemMarkIconImage;
			}
		}
		...
		public void DestroyWidget()
		{
			...
			this.m_E_ItemMarkIconImage = null;
		...
		private UnityEngine.UI.Image m_E_ItemMarkIconImage = null;
