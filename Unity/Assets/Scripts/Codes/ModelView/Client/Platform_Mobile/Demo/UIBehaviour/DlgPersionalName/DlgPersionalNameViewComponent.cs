...
namespace ET.Client
{
	...
	public class DlgPersionalNameViewComponent : Entity, IAwake, IDestroy
	{
		...
		public UnityEngine.UI.Button E_Save_NotClickableButton
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_E_Save_NotClickableButton == null )
				{
					this.m_E_Save_NotClickableButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject, "EGBackGround/Root/E_Save_NotClickable");
				}
				return this.m_E_Save_NotClickableButton;
			}
		}

		public UnityEngine.UI.Image E_Save_NotClickableImage
		{
			get
			{
				if (this.uiTransform == null)
				...
				if( this.m_E_Save_NotClickableImage == null )
				{
					this.m_E_Save_NotClickableImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject, "EGBackGround/Root/E_Save_NotClickable");
				}
				return this.m_E_Save_NotClickableImage;
			}
		}
		...
		public void DestroyWidget()
		{
			...
			this.m_E_Save_NotClickableButton = null;
			this.m_E_Save_NotClickableImage = null;
		...
		private UnityEngine.UI.Button m_E_Save_NotClickableButton = null;
		private UnityEngine.UI.Image m_E_Save_NotClickableImage = null;
