...
namespace ET.Client
{
    ...
    public static class DlgBattleTowerSystem
    {
        ...
        public static bool CheckCanPut(this DlgBattleTower self, Vector3 position)
        {
        ...
        public static bool ChkIsNearTower(this DlgBattleTower self, string towerId, float3 pos)
        {
