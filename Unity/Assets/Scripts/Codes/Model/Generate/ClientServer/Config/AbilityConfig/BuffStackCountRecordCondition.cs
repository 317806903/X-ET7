...
public sealed partial class BuffStackCountRecordCondition:  Condition 
{
    ...
    public static BuffStackCountRecordCondition DeserializeBuffStackCountRecordCondition(ByteBuf _buf)
    {
        return new BuffStackCountRecordCondition(_buf);
    }
    ...
    public const int __ID__ = -1276147664;
