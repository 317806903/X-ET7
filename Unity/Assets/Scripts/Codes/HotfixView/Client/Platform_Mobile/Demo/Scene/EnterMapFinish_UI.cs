...
namespace ET.Client
{
    ...
    public class EnterMapFinish_UI: AEvent<Scene, ClientEventType.EnterMapFinish>
    {
        protected override async ETTask Run(Scene scene, ClientEventType.EnterMapFinish args)
        {
            ...
            EventSystem.Instance.Publish(scene, new ClientEventType.NoticeUIShowCommonLoading());
            ...
            EventSystem.Instance.Publish(scene, new ClientEventType.NoticeUIHideCommonLoading());
        ...
        public async ETTask EnterMap_WhenAR(Scene scene)
        {
            ...
            float fARScale = gamePlayComponent.GetGameMapScale();
            ...
            if (gamePlayComponent.gamePlayMode == GamePlayMode.TowerDefense)
            {
                ...
                await UIManagerHelper.ShowBattleUI(scene);
            }
