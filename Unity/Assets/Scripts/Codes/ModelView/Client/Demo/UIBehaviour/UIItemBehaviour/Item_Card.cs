...
namespace ET.Client
{
	...
	public class Scroll_Item_Card : Entity, IAwake, IDestroy, IUIScrollItem
	{
		...
		public TMPro.TextMeshProUGUI ELabel_DesTextMeshProUGUI
		{
			get
			{
				if (this.uiTransform == null)
				...
				if (this.isCacheNode)
				{
					if( this.m_ELabel_DesTextMeshProUGUI == null )
					{
						this.m_ELabel_DesTextMeshProUGUI = UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject, "ELabel_Des");
					}
					return this.m_ELabel_DesTextMeshProUGUI;
				}
				else
				{
					return UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject, "ELabel_Des");
				}
			}
		}
		...
		public void DestroyWidget()
		{
			...
			this.m_ELabel_DesTextMeshProUGUI = null;
		...
		private TMPro.TextMeshProUGUI m_ELabel_DesTextMeshProUGUI = null;
