...
namespace ET.Ability
{
    ...
    public static class SelectHandleRecordManagerSystem
    {
        ...
        public static void FixedUpdate(this SelectHandleRecordManager self, float fixedDeltaTime)
        {
            ...
            {
                if (item.Key < TimeHelper.ServerFrameTime())
                {
        ...
        public static void DoRecordUnitsByArea(this SelectHandleRecordManager self, Unit unit, bool isResetPos, float3 resetPos, ActionCallAutoUnitArea actionCallAutoUnitArea, ListComponent<long> unitIds)
        {
            ...
            selectHandleRecord.actionCallAutoUnitArea = actionCallAutoUnitArea;
        ...
        public static (bool, ListComponent<long>) ChkRecordUnitsByArea(this SelectHandleRecordManager self, Unit unit, bool isResetPos, float3 resetPos, ActionCallAutoUnitArea actionCallAutoUnitArea)
        {
            ...
            return selectHandleRecord.Check(unit, isResetPos, resetPos, actionCallAutoUnitArea);
        }
    }
}