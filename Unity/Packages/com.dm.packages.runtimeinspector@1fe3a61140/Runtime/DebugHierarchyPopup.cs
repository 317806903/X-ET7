...
{
	public class DebugHierarchyPopup : MonoBehaviour, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
...
#pragma warning disable 0649
		[SerializeField]
		private ShowHierarchyManager debugManager;
...
#pragma warning restore 0649
		...
		public void OnPointerClick( PointerEventData data )
		{
			...
			if( !isPopupBeingDragged )
				debugManager.ShowHierarchyWindow();
		}
