...
/// 条件
/// </summary>
public abstract partial class UnitConditionBase: Bright.Config.BeanBase
{
    public UnitConditionBase(ByteBuf _buf) 
    {
        ConditionCompare = (ConditionCompare)_buf.ReadInt();
        PostInit();
    }

    public static UnitConditionBase DeserializeUnitConditionBase(ByteBuf _buf)
    {
        switch (_buf.ReadInt())
        {
            ...
            case SkillGroupTypeCondition.__ID__: return new SkillGroupTypeCondition(_buf);
            ...
            case DisCondition.__ID__: return new DisCondition(_buf);
