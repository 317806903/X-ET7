...
namespace ET.Client
{
	...
	public static class Scroll_Item_CardSystem
	{
		public static void Init(this Scroll_Item_Card self)
		{
		}
		
		public static void SetQuality(this Scroll_Item_Card self, string itemCfgId)
		{
		...
		public static void SetLabels(this Scroll_Item_Card self, string itemCfgId)
		{
		...
		public static void SetLevel(this Scroll_Item_Card self, string itemCfgId)
		{
