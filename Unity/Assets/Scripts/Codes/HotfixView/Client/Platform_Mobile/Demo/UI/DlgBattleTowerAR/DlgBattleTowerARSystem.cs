...
namespace ET.Client
{
    ...
    public static class DlgBattleTowerARSystem
    {
        ...
        public static void ShowOrHide(this DlgBattleTowerAR self, bool isShow)
        {
        ...
        public static async ETTask ShowGameInstructions(this DlgBattleTowerAR self)
        {
        ...
        public static async ETTask PreLoadRes(this DlgBattleTowerAR self)
        {
        ...
        public static List<(string, int)> GetTowerBuyList(this DlgBattleTowerAR self)
        {
            GamePlayTowerDefenseComponent gamePlayTowerDefenseComponent = self.GetGamePlayTowerDefense();
        ...
        public static async ETTask ForceNextWaveWhenDebug(this DlgBattleTowerAR self)
        {
            UIAudioManagerHelper.PlayUIAudio(self.DomainScene(),SoundEffectType.Back);
