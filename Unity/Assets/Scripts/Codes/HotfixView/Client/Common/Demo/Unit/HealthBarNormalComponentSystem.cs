...
namespace ET.Client
{
    public static class HealthBarNormalComponentSystem
    {
        ...
        public static async ETTask Init(this HealthBarNormalComponent self, bool isShowWhenFull)
        {
        ...
        public static Vector3 GetPos(this HealthBarNormalComponent self)
        {
            ...
            float height = ET.Ability.UnitHelper.GetBodyHeight(self.GetUnit()) + 0.75f * clientResScale;
            Vector3 position = (Vector3)self.GetUnit().GetUnitClientPos() + new Vector3(0, height, 0);
            return position;
        }
